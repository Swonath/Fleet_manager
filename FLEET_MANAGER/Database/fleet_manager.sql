...
-- Insérer un utilisateur super administrateur par défaut
INSERT INTO utilisateurs (nom_utilisateur, email, mot_de_passe, nom, prenom, role)
VALUES ('superadmin', 'superadmin@fleet-manager.com', 'superadmin123', 'Super', 'Administrateur', 'super_admin');

-- Insérer un utilisateur administrateur
INSERT INTO utilisateurs (nom_utilisateur, email, mot_de_passe, nom, prenom, role)
VALUES ('admin', 'admin@fleet-manager.com', 'admin123', 'Administrateur', 'Système', 'admin');
